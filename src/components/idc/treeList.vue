                        ...
                        <i-col :sm="12" :md="16" :lg="24">
                            <row>
                                ...
                                <i-col span="8">
                                    ...
                                    <!-- <input @change='getSltData' type="radio" name="idc-basis" value="IDC基础产品"
                                            v-model="productClass" checked class="group-radio">
                                        <label>IDC基础产品</label>
                                        <input @change='getSltData' type="radio" name="idc-basis" v-model="productClass"
